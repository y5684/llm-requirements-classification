...
if TUNING_METHOD == "full":
    ...
    peft_config = PromptTuningConfig(
        ...
        prompt_tuning_init_text=(
            "Classify the requirement as FR or NFR. Text:"
        ),
...
training_args = TrainingArguments(
    output_dir="./results_decoderonly_bin",
    eval_strategy="epoch",
    save_strategy="epoch",
...
print(classification_report(test_labels, test_preds, digits=4, target_names=["FR(0)", "NFR(1)"], zero_division=0))
