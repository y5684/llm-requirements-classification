...
# ==============================================
MODEL_NAME_OR_PATH = "t5-large"   # local path or identifier
...
if TUNING_METHOD == "full":
    ...
    peft_config = PromptTuningConfig(
        ...
        prompt_tuning_init_text=(
            "Given a requirement text, classify as "
...
target_names = ["Functional Requirement", "Non-Functional Requirement"]
